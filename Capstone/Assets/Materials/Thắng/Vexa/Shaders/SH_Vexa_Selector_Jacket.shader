    ...
    SubShader
    {
        ...
        half3 ApplyVexaLighting(half3 albedo, half3 normalWS, float3 positionWS, half occlusion, half3 emission)
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half4 selected = lerp(_ClothColor, _SkinColor, id01.r);
                selected = lerp(selected, _MetalColor, id01.g);
                selected = lerp(selected, _ClothSecondaryColor, id01.b);
