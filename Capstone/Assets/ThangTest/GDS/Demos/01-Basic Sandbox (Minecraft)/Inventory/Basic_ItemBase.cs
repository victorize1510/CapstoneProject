...
namespace GDS.Demos.Basic {
    ...
    public class Basic_ItemBase : ItemBase {
        public int Weight = 1;
        public int Cost = 1;
        public override Item CreateItem() => ItemExt.Create<Basic_Item>(this);
    }

    [System.Serializable]
    public class Basic_Item : Item {
        public Rarity Rarity;
        public override Item Clone() => new Basic_Item() { Id = Id, Base = Base, Name = Name, StackSize = StackSize, Rarity = Rarity };
    }
