...
namespace GDS.Core {
    ...
    public class ItemBaseEditor : Editor {
        ...
        public override VisualElement CreateInspectorGUI() {
            ...
            var image = Dom.Div("icon-preview", IconPreview());
            ...
            if (iterator.NextVisible(true)) {
                do {
                    ...
                    if (iterator.propertyPath == "Tags") {
                        propertyField.label = EditorUtil.CreateTagsLabel(serializedObject.FindProperty("Tags"));
                        propertyField.RegisterValueChangeCallback(e => propertyField.label = EditorUtil.CreateTagsLabel(serializedObject.FindProperty("Tags")));
                    }
        ...
        private void UpdatePreview(VisualElement el, Sprite sprite) {
            el.Clear();
            el.Add(IconPreview(sprite));
        }

        VisualElement IconPreview(Sprite sprite = null) => sprite == null ? new Label("No Icon") : new Image() { sprite = sprite };
