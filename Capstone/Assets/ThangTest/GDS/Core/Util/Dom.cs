...
namespace GDS.Core {
    ...
    public static class DomExt {
        ...
        public static T Toggle<T>(this T element) where T : VisualElement => element.style.display == DisplayStyle.None ? element.Show() : element.Hide();
        ...
        /// </summary>
        public static TElement Observe<TElement, T>(this TElement element, IObservable<T> observable, Action<T> callback) where TElement : VisualElement {
        ...
        public static TElement Observe<TElement, T>(this TElement element, IObservable<T> observable, Func<TElement, Action<T>> callback) where TElement : VisualElement {
        ...
        public static TElement BindText<TElement, T>(this TElement element, IObservable<T> observable) where TElement : Label {
        ...
        public static TElement BindValue<TElement, T>(this TElement element, IObservable<T> observable) where TElement : BaseField<T> {
            element.RegisterValueChangedCallback(ev => observable.SetValue(ev.newValue));
            return element.Observe(observable, el => value => el.value = value);
        }
